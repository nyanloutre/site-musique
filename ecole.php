        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-center">
                    ...
                    <hr class="light">
                    <p class="text-faded">L’école de musique "Les notes de l'Ill" a été créée par la Société de Musique Fraternité dont elle dépend exclusivement et est dirigée par Nathalie ROHRBACH. Les enseignements musicaux, notamment en groupe, tout en développant les techniques musicales et d’écoute mutuelle, permettent à chacun de s’exprimer poétiquement. L'école de musique contribue ainsi à un développement artistique personnel mais aussi au recrutement de futurs musiciens de l'Harmonie intercommunale Centre Haut-Rhin. L’école de Musique est subventionnée par la Commune de Meyenheim, la Communauté de Communes Centre Haut-Rhin et par le Conseil Départemental du Haut-Rhin.</p>
                    <hr>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 text-center">
                    <div class="service-box">
                        ...
                        <h3>Ateliers d’éveil musical et d’initiation musicale</h3>
                        <h4>Pour les enfants de la Grande section de Maternelle au CE1</h4>
                        <p class="text-muted">L’élève intègre un des groupes proposés par le professeur Nathalie ROHRBACH. Ces ateliers ont pour but de sensibiliser l’enfant aux sons, aux rythmes, aux couleurs musicales, de façon ludique et amusante. Ils offrent aux élèves la possibilité de découvrir leur voix comme outil musical et l’aideront à faire le choix d’un instrument pour la poursuite de l’apprentissage</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 text-center">
                    <div class="service-box">
                        ...
                        <p class="text-muted">Cours d’instrument ou de chant seul avec l’enseignant (30' à 45’ suivant le cas). L’élève et l’enseignant établissent ensemble en début d’année scolaire le projet et le programme musical</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 text-center">
                    <div class="service-box">
                ...
                <div class="col-lg-4 col-md-6 text-center">
                    <div class="service-box">
                        ...
                        <ul class="list-group">
                            ...
                            <li class="list-group-item" data-toggle="popover" data-content="Sur demande">La guitare acoustique
                            <li class="list-group-item" data-toggle="popover" data-content="Sur demande">La guitare électrique
                            <li class="list-group-item" data-toggle="popover" data-content="Stéphan HAFFNER" data-title="Enseignant">Le piano
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 text-center">
                    ...
                    <p><a href="mailto:contact@musique-meyenheim.fr">ecole@musique-meyenheim.fr</a></p>
                </div>
                <div class="col-lg-8 col-lg-offset-2 text-center">
